...
HD_PWD='D:/study/FPGA/study_project/image_processing/prj/image_processing/image_processing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_processing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source image_processing.tcl -notrace
