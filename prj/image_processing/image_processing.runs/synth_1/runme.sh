...
HD_PWD='D:/study/FPGA/study_project/image_processing/prj/image_processing/image_processing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_processing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_processing.tcl
